...
export function SalesCanvas({ onSave }: SalesCanvasProps) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4">
      {/* Save Bar */}
      {canvasData.isDirty && (
        <div className="sticky top-0 z-20 mb-4 p-3 rounded-xl flex items-center justify-between shadow-sm" style={{ backgroundColor: '#DEFF00' }}>
                ...
                (() => {
                  ...
                  return (
                    <div className="space-y-1">
                      ...
                      <div className="text-sm text-gray-600">{time} Uhr</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-4">
            {canvasData.decision.champion && (
              <div className="text-sm text-gray-700 mb-3 pb-3 border-b border-gray-100">
