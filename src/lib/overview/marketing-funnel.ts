...
export const MARKETING_FUNNEL_CACHE_TTL_SECONDS = 30 * 60;

export function marketingFunnelCacheKey(days: number): string {
  return `marketing-funnel:frontdesk:${days}d`;
}
...
export async function buildMarketingFunnel(days: number): Promise<MarketingFunnelResponse> {
